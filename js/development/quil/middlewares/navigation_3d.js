...
var vec__9837 = axis;
var a_x = cljs.core.nth.call(null,vec__9837,(0),null);
var a_y = cljs.core.nth.call(null,vec__9837,(1),null);
var a_z = cljs.core.nth.call(null,vec__9837,(2),null);
var vec__9840 = v;
var x = cljs.core.nth.call(null,vec__9840,(0),null);
var y = cljs.core.nth.call(null,vec__9840,(1),null);
var z = cljs.core.nth.call(null,vec__9840,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__9843,p__9844){
var vec__9845 = p__9843;
var u1 = cljs.core.nth.call(null,vec__9845,(0),null);
var u2 = cljs.core.nth.call(null,vec__9845,(1),null);
var u3 = cljs.core.nth.call(null,vec__9845,(2),null);
var vec__9848 = p__9844;
var v1 = cljs.core.nth.call(null,vec__9848,(0),null);
var v2 = cljs.core.nth.call(null,vec__9848,(1),null);
var v3 = cljs.core.nth.call(null,vec__9848,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__9851_SHARP_){
return (p1__9851_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
var rotate = (function (p1__9852_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__9852_SHARP_,axis,angle);
});
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301)], null),(function (p1__9853_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__9853_SHARP_,angle_lr),angle_ud);
}));
}
});
...
var map__9855 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__9855__$1 = (((((!((map__9855 == null))))?(((((map__9855.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9855.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9855):map__9855);
var up = cljs.core.get.call(null,map__9855__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__9855__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5718__auto__ = (function (){var pred__9857 = cljs.core._EQ_;
var expr__9858 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__9857.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__9858))){
return straight;
} else {
if(cljs.core.truth_(pred__9857.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__9858))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__9857.call(null,quil.middlewares.navigation_3d.space,expr__9858))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__9857.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__9858))){
return up;
} else {
if(cljs.core.truth_(pred__9857.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__9858))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__9857.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__9858))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),(function (p1__9854_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__9854_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
}));
} else {
return state;
}
...
return cljs.core.update_in.call(null,user_setup.call(null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301)], null),(function (p1__9860_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__9860_SHARP_);
}));
});
/**
...
var map__9861_9872 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__9861_9873__$1 = (((((!((map__9861_9872 == null))))?(((((map__9861_9872.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9861_9872.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9861_9872):map__9861_9872);
var vec__9862_9874 = cljs.core.get.call(null,map__9861_9873__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_9875 = cljs.core.nth.call(null,vec__9862_9874,(0),null);
var c_y_9876 = cljs.core.nth.call(null,vec__9862_9874,(1),null);
var c_z_9877 = cljs.core.nth.call(null,vec__9862_9874,(2),null);
var vec__9865_9878 = cljs.core.get.call(null,map__9861_9873__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_9879 = cljs.core.nth.call(null,vec__9865_9878,(0),null);
var u_y_9880 = cljs.core.nth.call(null,vec__9865_9878,(1),null);
var u_z_9881 = cljs.core.nth.call(null,vec__9865_9878,(2),null);
var vec__9868_9882 = cljs.core.get.call(null,map__9861_9873__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_9883 = cljs.core.nth.call(null,vec__9868_9882,(0),null);
var p_y_9884 = cljs.core.nth.call(null,vec__9868_9882,(1),null);
var p_z_9885 = cljs.core.nth.call(null,vec__9868_9882,(2),null);
quil.core.camera.call(null,p_x_9883,p_y_9884,p_z_9885,(p_x_9883 + c_x_9875),(p_y_9884 + c_y_9876),(p_z_9885 + c_z_9877),u_x_9879,u_y_9880,u_z_9881);
