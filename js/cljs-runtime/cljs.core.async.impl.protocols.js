...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_16822 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_16822(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_16841 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_16841(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_16842 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_16842(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_16843 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_16843(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_16852 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_16852(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_16853 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_16853(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_16854 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_16854(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_16855 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_16855(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_16856 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_16856(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_16858 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_16858(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_16860 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_16860(b);
}
});
