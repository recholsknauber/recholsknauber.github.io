...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_21697 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_21697(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_21707 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_21707(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_21708 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_21708(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_21714 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_21714(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21717 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21717(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21718 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21718(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__21690,callback){
var map__21691 = p__21690;
var map__21691__$1 = cljs.core.__destructure_map(map__21691);
var input = map__21691__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21691__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21691__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
