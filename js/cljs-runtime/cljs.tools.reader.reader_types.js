...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_16623 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_16623(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_16631 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_16631(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16640 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16640(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16648 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16648(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16653 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16653(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16655 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16655(reader);
}
});
...
var G__16708 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__16709 = s.append(c);
c = G__16708;
s = G__16709;
continue;
}
