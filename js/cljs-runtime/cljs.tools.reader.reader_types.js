...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11637 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11637(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11643 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11643(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11645 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11645(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11647 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11647(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11654 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11654(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11658 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11658(reader);
}
});
...
var G__11743 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11744 = s.append(c);
c = G__11743;
s = G__11744;
continue;
}
